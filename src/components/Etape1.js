    ...
    <div className='etape11'>
       ...
       >استاذ </button>
        ...
        <img src={Logo} className="colorcp"  alt="logo" />
          ...
          <img src={Po}  className="po5" style={{backgroundColor: '#12A8DA'}}  alt="po" /> 
          <img src={Po} className="po5"  style={{bottom:'82px', backgroundColor: '#12A8DA'}}  alt="po" /> 
          <img src={Po}  className="po5" style={{bottom:'0px'}}  alt="po" /> 
             <p className='p8' style={{top:' 10px'}}>انشاء حساب جديد</p>
             <p className='p8' style={{bottom:' 100px' , left:'100px'}}>التصنيف</p>
             <p className='p8' style={{bottom:' 10px' , left:'100px'}}>التسجيل</p>
